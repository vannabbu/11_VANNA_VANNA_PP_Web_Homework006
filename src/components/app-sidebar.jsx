...
const navItems = [
  { title: "Products", icon: LayoutGrid , url :'/products' },
  { title: "Customer", icon: Users , url :'/customers'},
  { title: "Categories", icon: BookOpen ,url :'/notfound' },
  { title: "Settings", icon: Settings  , url :'/noutfound'},
]
  ...
  return (
    <Sidebar className="border-r-0 bg-white">
      ...
      <SidebarContent className="px-4">
        <SidebarGroup>
          <SidebarGroupLabel className="mb-4 px-2 text-[11px] font-bold   text-slate-400">
            Main Menu
          </SidebarGroupLabel>
          <SidebarMenu>
            {navItems.map((item) => (
